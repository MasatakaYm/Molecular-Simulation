...
続いて, 分子座標における角速度$\tilde{\bm{\omega}}$を
...
% \begin{align}
%  & I_{xx}  \frac{d\Tilde{\omega}_{x}}{dt} - \Tilde{\omega}_{y} \Tilde{\omega}_{z} \left(I_{yy} - I_{xx}\right) = \tau_{\tilde{x}} \\
%  & I_{yy}  \frac{d\Tilde{\omega}_{y}}{dt} - \Tilde{\omega}_{z} \Tilde{\omega}_{x} \left(I_{zz} - I_{xx}\right) = \tau_{\tilde{y}}  \\
%  & I_{zz}  \frac{d\Tilde{\omega}_{z}}{dt} - \Tilde{\omega}_{x} \Tilde{\omega}_{y} \left(I_{xx} - I_{yy}\right) = \tau_{\tilde{z}}
% \end{align}
% 但し
% \begin{align}
