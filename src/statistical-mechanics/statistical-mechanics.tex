...
続いて, ハミルトニアンを導出する. ラグランジアンのルジャンドル変換よりハミルトニアンは
\begin{equation}
...
\begin{align}
  \frac{\partial H}{\partial L_{\alpha\gamma}} =
...
\begin{align}
  \sum_{\gamma=1}^{3} L_{\beta\gamma} \frac{\partial H}{\partial L_{\alpha\gamma}} =&
  -\sum_{i} \sum_{\mu,\nu,\lambda} \frac{\pi_{i\mu}\pi_{i\nu}}{2m_{i}}
