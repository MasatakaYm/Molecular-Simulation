...
\paragraph{まとめ}
以上の計算をまとめると, 3点間の角度$\theta_{ijk}$の粒子の位置ベクトル$\bm{r}_{\alpha}$微分は,
...
ここで, ベクトルの微分に関する公式を導出する. 以下, ベクトル$\bm{a}, \bm{b}, \bm{c}$を考える. 
\begin{align}
 \bm{a}= \left(
              \begin{array}{c}
               a_{x} \\
...
\paragraph{まとめ}
以上の計算をまとめると, 二面角$\phi_{ijkl}$の粒子の位置ベクトル$\bm{r}_{\alpha}$微分は
\begin{alignat}{4}
...
ここで, 
\begin{align}
    \frac{d}{d \bm{r}_{\alpha}} (\theta_{ijk} - \theta_{\mathrm{eq}})
 &=
    \frac{d}{d \bm{r}_{\alpha}}
    \arccos \left( \frac{\bm{r}_{ji} \cdot \bm{r}_{jk}}{r_{ji} r_{jk}} \right)
 \notag \\
...
\subparagraph{$\alpha = i$のときの$\bm{F}^{\mathrm{angle}}$の導出}
\begin{align}
    \frac{d}{d \bm{r}_{i}}
    \left(\frac{\bm{r}_{ji} \cdot \bm{r}_{jk}}{r_{ji} r_{jk}}\right)
 &=
...
\subparagraph{$\alpha = k$のときの$\bm{F}^{\mathrm{angle}}$の導出} \
...
\subparagraph{$\alpha = j$のときの$\bm{F}^{\mathrm{angle}}$の導出} \
\begin{align}
    \frac{d}{d \bm{r}_{j}}
    \left(\frac{\bm{r}_{ji} \cdot \bm{r}_{jk}}{r_{ji} r_{jk}}\right)
 =&
...
\begin{align}
     \frac{d \phi}{d \bm{r}_{\alpha}}
 = - \frac{1}{\sin\phi} \frac{d \cos\phi}{d \bm{r}_{\alpha}}
 = - \frac{1}{\sin\phi} \frac{d} {d \bm{r}_{\alpha}}
     \left(
           \frac{\bm{n}_{j} \cdot \bm{n}_{k}} {n_{j} n_{k}}
     \right)
 \notag
...
\begin{align}
 ...
 \notag
\end{align}
となる. したがって, $\alpha = i, j, k, l$に対する二面角の力の計算は
\begin{align}
    \frac{d}{d \bm{r}_{\alpha}}
    \left( \frac{\bm{n}_{j} \cdot \bm{n}_{k}} {n_{j} n_{k}} \right)
 =
...
\subparagraph{いくつかの便利な公式} \
ベクトルの微分に関する公式を導出する. 以下, ベクトル$\bm{a}, \bm{b}, \bm{c}$を考える. 
\begin{align}
 \bm{a}= \left(
              \begin{array}{c}
               a_{x} \\
...
\subparagraph{$\alpha = i$のときの$\bm{F}^{\mathrm{dihedral}}$の導出} \
\begin{align}
    \frac{d} {d \bm{r}_{i}} (\bm{n}_{j} \cdot \bm{n}_{k})
 &=
    \frac{d} {d \bm{r}_{i}}
...
\subparagraph{$\alpha = j$のときの$\bm{F}^{\mathrm{dihedral}}$の導出} \
\begin{align}
    \frac{d} {d \bm{r}_{j}} (\bm{n}_{j} \cdot \bm{n}_{k})
 =&
      \left( \frac{d}{d \bm{r}_{j}} \bm{n}_{j} \right) \cdot \bm{n}_{k}
...
\subparagraph{$\alpha = k$のときの$\bm{F}^{\mathrm{dihedral}}$の導出} \
\begin{align}
    \frac{d} {d \bm{r}_{k}} (\bm{n}_{j} \cdot \bm{n}_{k})
 =&
      \left( \frac{d}{d \bm{r}_{k}} \bm{n}_{j} \right) \cdot \bm{n}_{k}
...
\subparagraph{$\alpha = l$のときの$\bm{F}^{\mathrm{dihedral}}$の導出} \
\begin{align}
    \frac{d} {d \bm{r}_{l}} (\bm{n}_{j} \cdot \bm{n}_{k})
 =&
    \frac{d} {d \bm{r}_{l}}
